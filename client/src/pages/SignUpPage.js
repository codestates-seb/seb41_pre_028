  ...
  return (
    <div className="flex justify-center items-center h-screen bg-[#f1f2f3]">
      <div className=" flex flex-col justify-center gap-5  max-[640px]:flex-row">
        ...
        <div className="flex flex-row max-[640px]:hidden">
          <div>
        ...
        <div className="text-sm max-[640px]:hidden">
          ...
          <a
            ...
            rel="noreferrer"
          >
            <p className="text-[#0074cc] hover:text-[#0995ff]">
              Get Stack Overflow for Teams free for up to 50 users
            </p>
          </a>
        </div>
      </div>
      <div className="min-[640px]: ml-5 mr-5">
        <h1 className="flex text-center text-3xl mb-8 min-[640px]:hidden">
          Create your Stack Overflow account. It’s free and only takes a minute.
        </h1>
        <ButtonBox />
        <InputBox isSignup={true} />
        <div className="flex justify-center mt-4">
          Already have an account?
          <a href="/login" className="ml-2 text-[#0074cc] hover:text-[#0995ff]">
            Log in
          </a>
        </div>
      </div>
